...
export default function SearchBlog() {
    return (
        <div className="flex items-center w-full max-w-[439px] gap-2 mx-auto h-auto mt-3">
            ...
            <button className="h-11 w-22 px-4.5 py-2.5 rounded-[8px] flex items-center justify-center gap-2 bg-blue-600 text-white text-base font-medium hover:bg-blue-700 transition-colors">
                Cari
            </button>
        </div>
    )

...
import { NAV_LINKS, SOSIAL_LINKS } from "@/data/navigation";
import { AppStoreBadges } from "./appstorebadges";

const sociallinks = [
  {
    href: SOSIAL_LINKS.instagram,
    label: "Instagram",
    icon: (
      <svg
        width="24"
      ...
      >
        <g clipPath="url(#clip0_6027_6801)">
          <path
  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <g clipPath="url(#clip0_6027_6806)">
          <path
      ...
      <div className="mx-auto max-w-[1200px] px-6 lg:px-0 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-16 gap-y-10">
          ...
          <div className="flex flex-col items-start gap-x-16">
            ...
            <p className="mt-8 w-[323px] text-[16px] font-normal leading-6 text-[#535862]">
          ...
          {/* Kontak */}
          <div className="mr-8">
            <h3 className="mb-6 text-sm font-semibold text-gray-800 ">Kontak</h3>
            ...
            <div className="space-y-4 text-gray-600">
              <div className="flex items-start gap-3">
                <svg
                  ...
                  className="lucide lucide-phone text-gray-500 shrink-0 mt-0.5"
                >
              ...
              <div className="flex items-start gap-3">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-mail text-gray-500 shrink-0 mt-0.5"
                >
              ...
              <div className="flex items-start gap-3">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-map-pin text-gray-500 shrink-0 mt-0.5"
                >
                ...
                <p>
                  Jl. Khudori No.20b, RW.01, Gadingan, Wates, Kec. Wates,
          ...
          <div className="gap-x-8">
            ...
            <ul className="space-y-4 text-gray-600">
              <li>
                <Link href="/features">Fitur Aplikasi</Link>
              </li>

              <li>
                <Link href="/dashboard">Fitur CMS/Dashboard</Link>
              </li>

...
export default function faqCs() {
  return (
    <CardCs className='max-w-[792px] flex flex-col gap-[8px]'>
      ...
      <button className='mx-auto flex gap-[8px] bg-primary px-[18px] py-[10px] text-background font-semibold text-[16px] leading-[24px] rounded-[8px]'>Hubungi CS<ArrowUpRight /></button>
    </CardCs>
  )
}
